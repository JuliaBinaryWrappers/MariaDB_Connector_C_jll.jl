module MariaDB_Connector_C_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MariaDB_Connector_C_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("aabc7e14-95f1-5e66-9f32-aea603782360"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MariaDB_Connector_C", artifacts_toml) for e in artifacts["MariaDB_Connector_C"]]
...
if best_platform === nothing
    @debug("Unable to load MariaDB_Connector_C; unsupported platform $(triplet(platform_key_abi()))")
else
