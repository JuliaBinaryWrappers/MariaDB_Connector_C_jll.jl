# Autogenerated wrapper script for MariaDB_Connector_C_jll for i686-w64-mingw32
export libmariadb
...
const libmariadb_splitpath = ["lib", "mariadb", "libmariadb.dll"]
...
const libmariadb = "libmariadb.dll"
